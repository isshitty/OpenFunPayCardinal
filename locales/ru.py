...
oc_skip_if_reviewed = "{} Не отправлять, если отзыв оставлен"
...
🤝 <b><i>Баланс сделок:</i></b> <code>{}₽</code>"""
...
pl_author = "Автор"
pl_new = "Отправь мне плагин.\n\n<b>⚠️ ВНИМАНИЕ! Загрузка плагинов из сомнительных источников может привести к печальным последствиям.</b>"

au_user_settings = "Настройки для пользователя {}"
adv_fpc = "Доступ запрещен."
...
Автодеактивация лотов при отсутствии товара
